...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'invoice' => 'nota fiscal',
        'supply_order' => 'O.F.',
        'supply_company' => 'fornecedor',
        'financial_block_id' => 'de financiamento',
        'medication_id' => 'medicamento',
        'batch' => 'lote',
        'due_date' => 'data de validade',
        'quantity' => 'quantidade',
        'department_exit_id' => 'departamento',
        'department_entry_id' => 'departamento',
        'establishment_department_id' => 'departamento',
        'establishment_id' => 'estabelecimento',
        'consumable_id' => 'suprimento',
    ],
];
