                                ...
                                <x-table.table>
                                    ...
                                    @slot('tbody')
                                        @foreach ($dbInventoryEntries as $dbInventoryEntry)
                                            @if ($dbInventoryEntry->medication_id === $dbInventory->medication_id)
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="m-4 modal-body">
                                                                                ...
                                                                                <x-form.form method="create" route="{{route('inventory_pharmacy_centers.exitStore')}}">
                                                                                        ...
                                                                                        <x-form.input col="3" label="Apresentação" name="disabled" id="disabled" value="{{$dbInventoryEntry->Medication->MedicationUnit->title}}" disabled="disabled"/>
