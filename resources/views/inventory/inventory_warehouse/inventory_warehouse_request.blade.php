<x-pages.index>
    ...
    @slot('header')
        <x-header 
            routeJoker="{{route('inventory_warehouses.entryCreate', ['inventory_warehouse'=>$db->id])}}" btnTitleJoker="Entrada Avulsa" iconJoker="fas fa-clipboard-list"
    ...
    @slot('body')
        ...
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            <div>
                ...
                @include('inventory.inventory_warehouse.partials.request.inventory_warehouse_request_table')
            </div>
        </div>
