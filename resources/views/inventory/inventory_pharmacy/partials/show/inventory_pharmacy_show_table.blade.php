                                ...
                                <div class="text-left modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="text-lg font-semibold modal-title" id="Modal">Saída de Produto: {{$dbInventory->Medication->title}}</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="m-4 modal-body">
                                            <x-form.form method="create" route="{{route('inventory_pharmacies.exitStore')}}">
                                                ...
                                                <input hidden name="medication_id" value="{{$dbInventory->medication_id}}">

                                                <x-form.input col="12" label="Suprimento" name="disabled" value="{{$dbInventory->Medication->title}}" disabled="disabled"/>
                                                ...
                                                <x-form.input col="3" label="Apresentação" name="disabled" value="{{$dbInventory->Medication->MedicationUnit->title}}" disabled="disabled"/>
