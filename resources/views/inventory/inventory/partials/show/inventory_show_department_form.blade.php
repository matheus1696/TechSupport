<x-form.form method="create" route="{{route('inventory_histories.store')}}">
    ...
    <x-form.input col="2" label="Data" type="date" id="date" value="{{date('Y-m-d')}}" max="{{date('Y-m-d')}}" min="{{date('1900-01-01')}}"/>
    ...
    <x-form.input col="2" label="Quantidade" type="number" id="quantity" value="{{$db->birthday}}" min="0"/>
</x-form.form>