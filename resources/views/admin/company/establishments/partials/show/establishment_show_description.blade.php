<div class="text-sm row px-lg-2 py-lg-2">
    ...
    <p class="col-lg"><strong>Tipo de Estabelecimento: </strong>{{$db->TypeEstablishments->title}}</p>
    <p class="col-lg"><strong>Nivel de Atenção: </strong>{{$db->AttentionLevels->title}}</p>
</div>