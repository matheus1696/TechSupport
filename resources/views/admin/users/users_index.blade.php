                                ...
                                <td class="text-center">
                                    ...
                                    <x-button.minButtonModal id="UserModal{{$item->id}}" title="Dados do Perfil">
                                        <div class="row">
                                            ...
                                            <p class="col-lg-4"><strong>Sexo: </strong>{{$item->SexualOrientations->sexual_orientation
                                                ?? ""}}</p>
                                                ...
                                                <x-form.form method="edit" route="{{route('users.update',['user'=>$item->id])}}">
                                                    ...
                                                    <x-form.select col="12" label="Cargo" id="occupation_id">
                                                        ...
                                                        <option value="{{$dbCompanyOccupation->id}}" @if ($item->occupation_id ==
                                                            ...
                                                            - {{$dbCompanyOccupation->occupation}}</option>
                                                        @endforeach
                                                    </x-form.select>
                                                    ...
                                                    <x-form.select col="12" label="Estabelecimento" id="establishment_id">
                                                        ...
                                                        <option value="{{$dbEstablishment->id}}" @if ($item->establishment_id ==
                                                            $dbEstablishment->id) selected @endif>{{$dbEstablishment->establishment}}
                                                        </option>
                                                        @endforeach
                                                    </x-form.select>
                                                </x-form.form>
