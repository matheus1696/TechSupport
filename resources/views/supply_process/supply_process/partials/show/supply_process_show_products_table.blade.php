<x-table.table>
    @slot('thead')
        ...
        <x-table.td>Und.</x-table.td>
        <x-table.td>ADM</x-table.td>
        <x-table.td>ATB</x-table.td>
        <x-table.td>MAC</x-table.td>
        <x-table.td>VEPD</x-table.td>
        <x-table.td>VSAN</x-table.td>
        <x-table.td>Total</x-table.td>
        <x-table.td>Ações</x-table.td>
    @endslot
