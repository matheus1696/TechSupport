<div class="grid grid-cols-1 gap-3 mb-3 text-sm lg:grid-cols-3 mb-3">
    ...
    <p class="lg:col-span-3"><strong>Titulo: </strong>{{$db->title ?? ""}}</p>
    <div class="lg:col-span-3"><strong>Objetivo: </strong> {!! $db->description ?? "" !!} </div>
